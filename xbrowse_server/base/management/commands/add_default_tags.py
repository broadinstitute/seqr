...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for project_id in project_ids:
            ...
            get_or_create_project_tag(project, order=10, category="Collaboration", original_names=["Review", "Interesting"], tag_name="Review - variant and/or gene of interest", description="", color='#668FE3')
            ...
            get_or_create_project_tag(project, order=18, category="Data Sharing", original_names=["clinvar"], tag_name="Submit to Clinvar", description="", color='#8A62AE')
