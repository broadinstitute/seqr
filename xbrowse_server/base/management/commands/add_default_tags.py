...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for project_id in project_ids:
            ...
            get_or_create_project_tag(project, order=3, category="CMG Discovery Tags", tag_name="Tier 1 - Phenotype expansion", color='#298A49', description="Phenotype studies has different clinical characteristics and/or natural history")
            get_or_create_project_tag(project, order=4, category="CMG Discovery Tags", tag_name="Tier 1 - Phenotype not delineated", color='#44AA60', description="Phenotype not previously delineated (i.e. no MIM #...clarify with UW if this is PS# which is current understanding)")
            ...
            get_or_create_project_tag(project, order=8, category="CMG Discovery Tags", tag_name="Tier 2 - Phenotype not delineated", color='#318CC2', description="Phenotype not previously delineated (i.e. no MIM #...clarify with UW if this is PS# which is current understanding)")
            ...
            get_or_create_project_tag(project, order=16, category="ACMG Variant Classification", original_name="Incidental Finding", tag_name="Secondary finding", color="#FED82F",
