...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
      ...
      self.search_for_gene(gene_ids, args, max_af=options['max_af'])
      
      
    def search_for_gene(self, gene_ids, project_id_list, max_af=0.01):
      '''
        Search for a gene across project(s)
        Args:
            gene_ids: Gene IDs to search for
            project_id_list: An optional list of projects to narrow down the search
      '''
