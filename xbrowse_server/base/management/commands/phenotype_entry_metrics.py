...
class Command(BaseCommand):
    ...
    def process_project(self, project_id):
        ...
        try:
            ...
            return self.get_phenotype_entry_details_for_individuals(project_id, individuals)
        except Exception as e:
            print '\nsorry, we encountered an error finding project:', e, '\n'
            raise

    def get_phenotype_entry_details_for_individuals(self, project_id, individuals):
        """
        ...
        for individual in individuals:
            phenotype_count_for_indiv = phenotype_entry_metric_for_individual(project_id, individual)
