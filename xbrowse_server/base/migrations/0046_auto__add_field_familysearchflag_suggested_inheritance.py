...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilySearchFlag.suggested_inheritance'
        db.add_column('base_familysearchflag', 'suggested_inheritance',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilySearchFlag.suggested_inheritance'
        db.delete_column('base_familysearchflag', 'suggested_inheritance')
