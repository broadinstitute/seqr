...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('base_project_managers')
        ...
        m2m_table_name = db.shorten_name('base_project_collaborators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['base.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('base_project_managers'))

        # Removing M2M table for field collaborators on 'Project'
        db.delete_table(db.shorten_name('base_project_collaborators'))
    ...
    models = {
        ...
        'base.project': {
            ...
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'collaborator_projects'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            ...
            'managers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'manager_projects'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
