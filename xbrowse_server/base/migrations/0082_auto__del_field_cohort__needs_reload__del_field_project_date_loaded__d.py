...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'base_cohort', '_needs_reload')

        # Deleting field 'Project.date_loaded'
        db.delete_column(u'base_project', 'date_loaded')

        # Deleting field 'Family._needs_reload'
        db.delete_column(u'base_family', '_needs_reload')


    def backwards(self, orm):
        # Adding field 'Cohort._needs_reload'
        db.add_column(u'base_cohort', '_needs_reload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.date_loaded'
        db.add_column(u'base_project', 'date_loaded',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'Family._needs_reload'
        db.add_column(u'base_family', '_needs_reload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
