...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.pedigree_image'
        db.add_column('base_family', 'pedigree_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.pedigree_image'
        db.delete_column('base_family', 'pedigree_image')
