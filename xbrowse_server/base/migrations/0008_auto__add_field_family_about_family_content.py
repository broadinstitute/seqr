...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.about_family_content'
        db.add_column('base_family', 'about_family_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.about_family_content'
        db.delete_column('base_family', 'about_family_content')
