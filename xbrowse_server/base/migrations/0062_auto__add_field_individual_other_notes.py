...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individual.other_notes'
        db.add_column('base_individual', 'other_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individual.other_notes'
        db.delete_column('base_individual', 'other_notes')
    ...
    models = {
        ...
        'base.individual': {
            ...
            'other_notes': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
