...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCollaborator'
        db.create_table('base_projectcollaborator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Project'])),
            ('collaborator_type', self.gf('django.db.models.fields.CharField')(default='collaborator', max_length=20)),
        ))
        db.send_create_signal('base', ['ProjectCollaborator'])


    def backwards(self, orm):
        # Deleting model 'ProjectCollaborator'
        db.delete_table('base_projectcollaborator')
    ...
    models = {
        ...
        'base.project': {
            ...
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'through': "orm['base.ProjectCollaborator']", 'blank': 'True'}),
