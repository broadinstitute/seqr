...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.default_control_cohort'
        db.add_column(u'base_project', 'default_control_cohort',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.default_control_cohort'
        db.delete_column(u'base_project', 'default_control_cohort')
