...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.analysis_status'
        db.add_column('base_family', 'analysis_status',
                      self.gf('django.db.models.fields.CharField')(default='I', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.analysis_status'
        db.delete_column('base_family', 'analysis_status')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 0, 0)'}),
