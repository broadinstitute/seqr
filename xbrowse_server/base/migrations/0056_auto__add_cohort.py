...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cohort'
        db.create_table('base_cohort', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Project'], null=True, blank=True)),
            ('cohort_id', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True)),
            ('short_description', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True)),
            ('variant_stats_json', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('base', ['Cohort'])

        # Adding M2M table for field individuals on 'Cohort'
        m2m_table_name = db.shorten_name('base_cohort_individuals')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cohort', models.ForeignKey(orm['base.cohort'], null=False)),
            ('individual', models.ForeignKey(orm['base.individual'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cohort_id', 'individual_id'])


    def backwards(self, orm):
        # Deleting model 'Cohort'
        db.delete_table('base_cohort')

        # Removing M2M table for field individuals on 'Cohort'
        db.delete_table(db.shorten_name('base_cohort_individuals'))
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
        ...
        'base.individual': {
            ...
            'has_variants': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
