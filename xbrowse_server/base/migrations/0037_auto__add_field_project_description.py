...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('base_project', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('base_project', 'description')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
            ...
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
