...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('base_userprofile_projects_can_admin')
        ...
        # Changing field 'Individual.other_notes'
        db.alter_column('base_individual', 'other_notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Removing M2M table for field projects_can_admin on 'UserProfile'
        db.delete_table(db.shorten_name('base_userprofile_projects_can_admin'))


        # Changing field 'Individual.other_notes'
        db.alter_column('base_individual', 'other_notes', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 28, 0, 0)'}),
