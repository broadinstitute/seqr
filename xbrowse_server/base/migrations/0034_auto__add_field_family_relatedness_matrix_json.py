...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.relatedness_matrix_json'
        db.add_column('base_family', 'relatedness_matrix_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.relatedness_matrix_json'
        db.delete_column('base_family', 'relatedness_matrix_json')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
