...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individual.project'
        db.add_column('base_individual', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individual.project'
        db.delete_column('base_individual', 'project_id')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 24, 0, 0)'}),
