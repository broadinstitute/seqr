...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilySearchFlag.flag_type'
        db.add_column('base_familysearchflag', 'flag_type',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilySearchFlag.flag_type'
        db.delete_column('base_familysearchflag', 'flag_type')
