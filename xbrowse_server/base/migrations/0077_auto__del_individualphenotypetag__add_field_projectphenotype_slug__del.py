...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'IndividualPhenotypeTag'
        db.delete_table(u'base_individualphenotypetag')

        # Removing M2M table for field projects_can_view on 'UserProfile'
        db.delete_table(db.shorten_name(u'base_userprofile_projects_can_view'))

        # Removing M2M table for field projects_can_admin on 'UserProfile'
        db.delete_table(db.shorten_name(u'base_userprofile_projects_can_admin'))

        # Removing M2M table for field projects_can_edit on 'UserProfile'
        db.delete_table(db.shorten_name(u'base_userprofile_projects_can_edit'))

        # Adding field 'ProjectPhenotype.slug'
        db.add_column(u'base_projectphenotype', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='pheno', max_length=140),
                      keep_default=False)

        # Deleting field 'Family.is_cohort'
        db.delete_column(u'base_family', 'is_cohort')

        # Adding field 'Individual.bam_file'
        db.add_column(u'base_individual', 'bam_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datasets.BAMFile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'IndividualPhenotypeTag'
        db.create_table(u'base_individualphenotypetag', (
            ('phenotype_slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('individual', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Individual'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('base', ['IndividualPhenotypeTag'])

        # Adding M2M table for field projects_can_view on 'UserProfile'
        m2m_table_name = db.shorten_name(u'base_userprofile_projects_can_view')
        ...
        # Adding M2M table for field projects_can_admin on 'UserProfile'
        m2m_table_name = db.shorten_name(u'base_userprofile_projects_can_admin')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['base.userprofile'], null=False)),
            ('project', models.ForeignKey(orm['base.project'], null=False))
        ...
        # Adding M2M table for field projects_can_edit on 'UserProfile'
        m2m_table_name = db.shorten_name(u'base_userprofile_projects_can_edit')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['base.userprofile'], null=False)),
            ('project', models.ForeignKey(orm['base.project'], null=False))
        ...
        # Deleting field 'ProjectPhenotype.slug'
        db.delete_column(u'base_projectphenotype', 'slug')

        # Adding field 'Family.is_cohort'
        db.add_column(u'base_family', 'is_cohort',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Individual.bam_file'
        db.delete_column(u'base_individual', 'bam_file_id')
    ...
    models = {
        ...
        u'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 12, 0, 0)'}),
