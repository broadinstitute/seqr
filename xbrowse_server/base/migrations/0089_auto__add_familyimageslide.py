...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FamilyImageSlide'
        db.create_table(u'base_familyimageslide', (
        ...
        db.send_create_signal(u'base', ['FamilyImageSlide'])


    def backwards(self, orm):
        # Deleting model 'FamilyImageSlide'
        db.delete_table(u'base_familyimageslide')
