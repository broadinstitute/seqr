...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flag.inheritance_json'
        db.add_column('base_flag', 'inheritance_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Flag.search_profile_json'
        db.add_column('base_flag', 'search_profile_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flag.inheritance_json'
        db.delete_column('base_flag', 'inheritance_json')

        # Deleting field 'Flag.search_profile_json'
        db.delete_column('base_flag', 'search_profile_json')
