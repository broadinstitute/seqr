...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('base_flag', (
            ...
            ('alt', self.gf('django.db.models.fields.TextField')(default='')),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('search_profile_json', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('oid_string', self.gf('django.db.models.fields.CharField')(default='', max_length=24)),
            ('reason_for_flag', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('bp1', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('chr', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ('ref', self.gf('django.db.models.fields.TextField')(default='')),
        ))
