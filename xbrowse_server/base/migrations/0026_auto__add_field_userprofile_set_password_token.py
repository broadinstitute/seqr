...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.set_password_token'
        db.add_column('base_userprofile', 'set_password_token',
        ...
        db.create_table('base_userprofile_projects_can_view', (
        ...
        db.create_unique('base_userprofile_projects_can_view', ['userprofile_id', 'project_id'])

        # Adding M2M table for field projects_can_edit on 'UserProfile'
        db.create_table('base_userprofile_projects_can_edit', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['base.userprofile'], null=False)),
            ('project', models.ForeignKey(orm['base.project'], null=False))
        ))
        db.create_unique('base_userprofile_projects_can_edit', ['userprofile_id', 'project_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.set_password_token'
        db.delete_column('base_userprofile', 'set_password_token')

        # Removing M2M table for field projects_can_view on 'UserProfile'
        db.delete_table('base_userprofile_projects_can_view')

        # Removing M2M table for field projects_can_edit on 'UserProfile'
        db.delete_table('base_userprofile_projects_can_edit')
    ...
    models = {
        ...
        'base.family': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 0, 0)'}),
