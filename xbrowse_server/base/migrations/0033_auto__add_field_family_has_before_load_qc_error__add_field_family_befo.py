...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.has_before_load_qc_error'
        db.add_column('base_family', 'has_before_load_qc_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Family.before_load_qc_json'
        db.add_column('base_family', 'before_load_qc_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Family.has_after_load_qc_error'
        db.add_column('base_family', 'has_after_load_qc_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Family.after_load_qc_json'
        db.add_column('base_family', 'after_load_qc_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.has_before_load_qc_error'
        db.delete_column('base_family', 'has_before_load_qc_error')

        # Deleting field 'Family.before_load_qc_json'
        db.delete_column('base_family', 'before_load_qc_json')

        # Deleting field 'Family.has_after_load_qc_error'
        db.delete_column('base_family', 'has_after_load_qc_error')

        # Deleting field 'Family.after_load_qc_json'
        db.delete_column('base_family', 'after_load_qc_json')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 0, 0)'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 0, 0)'}),
