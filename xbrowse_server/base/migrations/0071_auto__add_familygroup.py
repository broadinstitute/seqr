...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FamilyGroup'
        db.create_table('base_familygroup', (
        ...
        db.send_create_signal('base', ['FamilyGroup'])

        # Adding M2M table for field families on 'FamilyGroup'
        m2m_table_name = db.shorten_name('base_familygroup_families')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('familygroup', models.ForeignKey(orm['base.familygroup'], null=False)),
            ('family', models.ForeignKey(orm['base.family'], null=False))
        ))
        db.create_unique(m2m_table_name, ['familygroup_id', 'family_id'])


    def backwards(self, orm):
        # Deleting model 'FamilyGroup'
        db.delete_table('base_familygroup')

        # Removing M2M table for field families on 'FamilyGroup'
        db.delete_table(db.shorten_name('base_familygroup_families'))
    ...
    models = {
        ...
        'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'}),
