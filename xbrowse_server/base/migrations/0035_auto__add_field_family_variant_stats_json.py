...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.variant_stats_json'
        db.add_column('base_family', 'variant_stats_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.variant_stats_json'
        db.delete_column('base_family', 'variant_stats_json')
