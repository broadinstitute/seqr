...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SavedVariantQuery'
        db.delete_table('base_savedvariantquery')


    def backwards(self, orm):
        # Adding model 'SavedVariantQuery'
        db.create_table('base_savedvariantquery', (
            ...
            ('variant_query_json', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('population', self.gf('django.db.models.fields.CharField')(default='AF', max_length=140, blank=True)),
        ))
        db.send_create_signal('base', ['SavedVariantQuery'])
