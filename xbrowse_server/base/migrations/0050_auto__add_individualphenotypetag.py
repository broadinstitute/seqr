...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('base_individualphenotypetag', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('base_individualphenotypetag')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 2, 0, 0)'}),
