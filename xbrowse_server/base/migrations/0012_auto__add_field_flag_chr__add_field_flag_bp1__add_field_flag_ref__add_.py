...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flag.chr'
        db.add_column('base_flag', 'chr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Flag.bp1'
        db.add_column('base_flag', 'bp1',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Flag.ref'
        db.add_column('base_flag', 'ref',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Flag.alt'
        db.add_column('base_flag', 'alt',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flag.chr'
        db.delete_column('base_flag', 'chr')

        # Deleting field 'Flag.bp1'
        db.delete_column('base_flag', 'bp1')

        # Deleting field 'Flag.ref'
        db.delete_column('base_flag', 'ref')

        # Deleting field 'Flag.alt'
        db.delete_column('base_flag', 'alt')
