...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.coll_name'
        db.delete_column('base_project', 'coll_name')

        # Adding field 'Family.coll_name'
        db.add_column('base_family', 'coll_name',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.coll_name'
        db.add_column('base_project', 'coll_name',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=140, blank=True),
                      keep_default=False)

        # Deleting field 'Family.coll_name'
        db.delete_column('base_family', 'coll_name')
    ...
    models = {
        ...
        'base.family': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 5, 0, 0)'}),
