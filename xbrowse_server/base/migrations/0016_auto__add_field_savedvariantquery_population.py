...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedVariantQuery.population'
        db.add_column('base_savedvariantquery', 'population',
                      self.gf('django.db.models.fields.CharField')(default='AF', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedVariantQuery.population'
        db.delete_column('base_savedvariantquery', 'population')
