...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferencePopulation.file_type'
        db.add_column(u'base_referencepopulation', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'ReferencePopulation.file_path'
        db.add_column(u'base_referencepopulation', 'file_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferencePopulation.file_type'
        db.delete_column(u'base_referencepopulation', 'file_type')

        # Deleting field 'ReferencePopulation.file_path'
        db.delete_column(u'base_referencepopulation', 'file_path')
    ...
    models = {
        ...
        u'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 14, 0, 0)'}),
