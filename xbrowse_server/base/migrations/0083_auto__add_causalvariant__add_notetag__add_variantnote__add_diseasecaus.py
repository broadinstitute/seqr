...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CausalVariant'
        db.create_table(u'base_causalvariant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('disease_cause', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DiseaseCause'])),
            ('variant_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('xpos', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('ref', self.gf('django.db.models.fields.TextField')(null=True)),
            ('alt', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'base', ['CausalVariant'])

        # Adding model 'NoteTag'
        db.create_table(u'base_notetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('color', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
        ))
        db.send_create_signal(u'base', ['NoteTag'])

        # Adding model 'VariantNote'
        db.create_table(u'base_variantnote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('xpos', self.gf('django.db.models.fields.BigIntegerField')()),
            ('ref', self.gf('django.db.models.fields.TextField')()),
            ...
            ('individual', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Individual'], null=True, blank=True)),
        ))
        db.send_create_signal(u'base', ['VariantNote'])

        # Adding M2M table for field tags on 'VariantNote'
        m2m_table_name = db.shorten_name(u'base_variantnote_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('variantnote', models.ForeignKey(orm[u'base.variantnote'], null=False)),
            ('notetag', models.ForeignKey(orm[u'base.notetag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['variantnote_id', 'notetag_id'])

        # Adding model 'DiseaseCause'
        db.create_table(u'base_diseasecause', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Family'])),
        ))
        db.send_create_signal(u'base', ['DiseaseCause'])


    def backwards(self, orm):
        # Deleting model 'CausalVariant'
        db.delete_table(u'base_causalvariant')

        # Deleting model 'NoteTag'
        db.delete_table(u'base_notetag')

        # Deleting model 'VariantNote'
        db.delete_table(u'base_variantnote')

        # Removing M2M table for field tags on 'VariantNote'
        db.delete_table(db.shorten_name(u'base_variantnote_tags'))

        # Deleting model 'DiseaseCause'
        db.delete_table(u'base_diseasecause')
    ...
    models = {
        ...
        u'base.causalvariant': {
            ...
            'disease_cause': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.DiseaseCause']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ref': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'variant_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        u'base.variantnote': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Project']"}),
            'ref': ('django.db.models.fields.TextField', [], {}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['base.NoteTag']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'xpos': ('django.db.models.fields.BigIntegerField', [], {})
        },
        u'base.vcffile': {
