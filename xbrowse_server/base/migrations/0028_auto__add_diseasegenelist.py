...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiseaseGeneList'
        db.create_table('base_diseasegenelist', (
        ...
        db.send_create_signal('base', ['DiseaseGeneList'])


    def backwards(self, orm):
        # Deleting model 'DiseaseGeneList'
        db.delete_table('base_diseasegenelist')
    ...
    models = {
        ...
        'base.family': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 11, 0, 0)'}),
