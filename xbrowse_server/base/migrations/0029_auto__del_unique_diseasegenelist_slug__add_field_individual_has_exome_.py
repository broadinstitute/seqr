...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DiseaseGeneList', fields ['slug']
        db.delete_unique('base_diseasegenelist', ['slug'])

        # Adding field 'Individual.has_exome'
        db.add_column('base_individual', 'has_exome',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Family.exomes_loaded'
        db.add_column('base_family', 'exomes_loaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Family.needs_inheritance_update'
        db.add_column('base_family', 'needs_inheritance_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding unique constraint on 'DiseaseGeneList', fields ['slug']
        db.create_unique('base_diseasegenelist', ['slug'])

        # Deleting field 'Individual.has_exome'
        db.delete_column('base_individual', 'has_exome')

        # Deleting field 'Family.exomes_loaded'
        db.delete_column('base_family', 'exomes_loaded')

        # Deleting field 'Family.needs_inheritance_update'
        db.delete_column('base_family', 'needs_inheritance_update')
    ...
    models = {
        ...
        'base.family': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 0, 0)'}),
