...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.last_accessed_date'
        db.add_column(u'base_project', 'last_accessed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.last_accessed_date'
        db.delete_column(u'base_project', 'last_accessed_date')
    ...
    models = {
        ...
        u'base.project': {
            ...
            'last_accessed_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
