...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferencePopulation'
        db.create_table('base_referencepopulation', (
        ...
        db.send_create_signal('base', ['ReferencePopulation'])

        # Adding M2M table for field private_reference_populations on 'Project'
        m2m_table_name = db.shorten_name('base_project_private_reference_populations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['base.project'], null=False)),
            ('referencepopulation', models.ForeignKey(orm['base.referencepopulation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'referencepopulation_id'])


    def backwards(self, orm):
        # Deleting model 'ReferencePopulation'
        db.delete_table('base_referencepopulation')

        # Removing M2M table for field private_reference_populations on 'Project'
        db.delete_table(db.shorten_name('base_project_private_reference_populations'))
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
