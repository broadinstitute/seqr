...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FamilySearchFlag'
        db.create_table('base_familysearchflag', (
            ...
            ('search_spec', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('base', ['FamilySearchFlag'])


    def backwards(self, orm):
        # Deleting model 'FamilySearchFlag'
        db.delete_table('base_familysearchflag')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)'}),
        ...
        'base.familysearchflag': {
            ...
            'search_spec': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
