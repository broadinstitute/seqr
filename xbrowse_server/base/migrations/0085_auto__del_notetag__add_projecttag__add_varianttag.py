...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'base_projecttag', (
        ...
        db.send_create_signal(u'base', ['ProjectTag'])

        # Adding model 'VariantTag'
        db.create_table(u'base_varianttag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project_tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.ProjectTag'])),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Family'], null=True)),
        ))
        db.send_create_signal(u'base', ['VariantTag'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'base_projecttag')

        # Deleting model 'VariantTag'
        db.delete_table(u'base_varianttag')
