...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectPhenotype'
        db.create_table('base_projectphenotype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=140)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('datatype', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('base', ['ProjectPhenotype'])

        # Adding model 'IndividualPhenotype'
        db.create_table('base_individualphenotype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('individual', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Individual'])),
            ('phenotype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.ProjectPhenotype'])),
            ('boolean_val', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('float_val', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('base', ['IndividualPhenotype'])


    def backwards(self, orm):
        # Deleting model 'ProjectPhenotype'
        db.delete_table('base_projectphenotype')

        # Deleting model 'IndividualPhenotype'
        db.delete_table('base_individualphenotype')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 26, 0, 0)'}),
