...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyImageSlide.caption'
        db.add_column(u'base_familyimageslide', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilyImageSlide.caption'
        db.delete_column(u'base_familyimageslide', 'caption')
