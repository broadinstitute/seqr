...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariantTag.xpos'
        db.add_column(u'base_varianttag', 'xpos',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VariantTag.ref'
        db.add_column(u'base_varianttag', 'ref',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'VariantTag.alt'
        db.add_column(u'base_varianttag', 'alt',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariantTag.xpos'
        db.delete_column(u'base_varianttag', 'xpos')

        # Deleting field 'VariantTag.ref'
        db.delete_column(u'base_varianttag', 'ref')

        # Deleting field 'VariantTag.alt'
        db.delete_column(u'base_varianttag', 'alt')
