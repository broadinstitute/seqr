...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VCFFile.needs_reannotate'
        db.add_column('base_vcffile', 'needs_reannotate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VCFFile.needs_reannotate'
        db.delete_column('base_vcffile', 'needs_reannotate')
    ...
    models = {
        ...
        'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)'}),
