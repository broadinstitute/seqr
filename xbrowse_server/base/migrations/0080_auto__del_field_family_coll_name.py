...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'base_family', 'coll_name')


    def backwards(self, orm):
        # Adding field 'Family.coll_name'
        db.add_column(u'base_family', 'coll_name',
    ...
    models = {
        ...
        u'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 14, 0, 0)'}),
