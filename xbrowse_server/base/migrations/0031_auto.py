...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field list_admins on 'DiseaseGeneList'
        db.create_table('base_diseasegenelist_list_admins', (
        ...
        db.create_unique('base_diseasegenelist_list_admins', ['diseasegenelist_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field list_admins on 'DiseaseGeneList'
        db.delete_table('base_diseasegenelist_list_admins')
    ...
    models = {
        ...
        'base.family': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 0, 0)'}),
