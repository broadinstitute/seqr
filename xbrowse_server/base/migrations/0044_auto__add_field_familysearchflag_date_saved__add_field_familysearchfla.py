...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilySearchFlag.date_saved'
        db.add_column('base_familysearchflag', 'date_saved',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'FamilySearchFlag.note'
        db.add_column('base_familysearchflag', 'note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilySearchFlag.date_saved'
        db.delete_column('base_familysearchflag', 'date_saved')

        # Deleting field 'FamilySearchFlag.note'
        db.delete_column('base_familysearchflag', 'note')
