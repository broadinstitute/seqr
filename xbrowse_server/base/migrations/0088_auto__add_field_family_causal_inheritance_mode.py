...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.causal_inheritance_mode'
        db.add_column(u'base_family', 'causal_inheritance_mode',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.causal_inheritance_mode'
        db.delete_column(u'base_family', 'causal_inheritance_mode')
