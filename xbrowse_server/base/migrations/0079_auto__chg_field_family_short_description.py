...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Family.short_description'
        db.alter_column(u'base_family', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Family.short_description'
        db.alter_column(u'base_family', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    models = {
        ...
        u'base.project': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 2, 0, 0)'}),
