...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Family.short_description'
        db.add_column('base_family', 'short_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Family.short_description'
        db.delete_column('base_family', 'short_description')
