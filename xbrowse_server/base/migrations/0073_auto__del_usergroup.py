...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('base_usergroup')


    def backwards(self, orm):
        # Adding model 'UserGroup'
        db.create_table('base_usergroup', (
            ('group_id', self.gf('django.db.models.fields.SlugField')(max_length=40, unique=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('base', ['UserGroup'])
