...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CausalVariant.disease_cause'
        db.delete_column(u'base_causalvariant', 'disease_cause_id')

        # Adding field 'CausalVariant.family'
        db.add_column(u'base_causalvariant', 'family',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Family'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CausalVariant.disease_cause'
        raise RuntimeError("Cannot reverse this migration. 'CausalVariant.disease_cause' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CausalVariant.disease_cause'
        db.add_column(u'base_causalvariant', 'disease_cause',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DiseaseCause']),
                      keep_default=False)

        # Deleting field 'CausalVariant.family'
        db.delete_column(u'base_causalvariant', 'family_id')
