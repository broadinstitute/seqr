...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Individual.has_variants'
        db.add_column('base_individual', 'has_variants',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Individual.has_variants'
        db.delete_column('base_individual', 'has_variants')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
