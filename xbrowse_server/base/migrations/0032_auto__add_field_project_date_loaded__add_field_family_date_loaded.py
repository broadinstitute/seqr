...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.date_loaded'
        db.add_column('base_project', 'date_loaded',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'Family.date_loaded'
        db.add_column('base_family', 'date_loaded',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.date_loaded'
        db.delete_column('base_project', 'date_loaded')

        # Deleting field 'Family.date_loaded'
        db.delete_column('base_family', 'date_loaded')
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 14, 0, 0)'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated_from_xbrowse': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 14, 0, 0)'}),
