...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VCFFile'
        db.create_table('base_vcffile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file_path', self.gf('django.db.models.fields.CharField')(default='', max_length=500)),
        ))
        db.send_create_signal('base', ['VCFFile'])

        # Adding M2M table for field vcf_files on 'Individual'
        m2m_table_name = db.shorten_name('base_individual_vcf_files')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('individual', models.ForeignKey(orm['base.individual'], null=False)),
            ('vcffile', models.ForeignKey(orm['base.vcffile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['individual_id', 'vcffile_id'])


    def backwards(self, orm):
        # Deleting model 'VCFFile'
        db.delete_table('base_vcffile')

        # Removing M2M table for field vcf_files on 'Individual'
        db.delete_table(db.shorten_name('base_individual_vcf_files'))
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 23, 0, 0)'}),
