...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectGeneList'
        db.create_table('base_projectgenelist', (
        ...
        db.send_create_signal('base', ['ProjectGeneList'])


    def backwards(self, orm):
        # Deleting model 'ProjectGeneList'
        db.delete_table('base_projectgenelist')
