...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilySearchFlag.search_spec'
        db.delete_column('base_familysearchflag', 'search_spec')

        # Adding field 'FamilySearchFlag.search_spec_json'
        db.add_column('base_familysearchflag', 'search_spec_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FamilySearchFlag.search_spec'
        db.add_column('base_familysearchflag', 'search_spec',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'FamilySearchFlag.search_spec_json'
        db.delete_column('base_familysearchflag', 'search_spec_json')
