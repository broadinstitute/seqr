...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field disease_gene_lists on 'Project'
        m2m_table_name = db.shorten_name('base_project_disease_gene_lists')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['base.project'], null=False)),
            ('diseasegenelist', models.ForeignKey(orm['base.diseasegenelist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'diseasegenelist_id'])


    def backwards(self, orm):
        # Removing M2M table for field disease_gene_lists on 'Project'
        db.delete_table(db.shorten_name('base_project_disease_gene_lists'))
    ...
    models = {
        ...
        'base.family': {
            ...
            'date_loaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)'}),
