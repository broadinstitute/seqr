...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('base_project', 'project_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('base_project', 'project_id')
    ...
    models = {
        ...
        'base.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project_id': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '140', 'blank': 'True'}),
            'project_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '140', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '140', 'blank': 'True'})
        },
