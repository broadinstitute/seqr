...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneList.last_updated'
        db.add_column(u'gene_lists_genelist', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeneList.last_updated'
        db.delete_column(u'gene_lists_genelist', 'last_updated')
