...
from reference_data.management.commands.update_gene_cn_sensitivity import GeneCopyNumberSensitivityReferenceDataHandler
...
REFERENCE_DATA_SOURCES = OrderedDict([
    ...
    ("gene_cn_sensitivity", GeneCopyNumberSensitivityReferenceDataHandler),
