...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('dbnsfp_gene_table', help="The dbNSFP gene table. Currently it's only available as "
            "part of the much larger dbNSFPv3.5a.zip download from https://sites.google.com/site/jpopgen/dbNSFP")
    ...
    def handle(self, *args, **options):
        ...
        with open(dbnsfp_gene_table_path) as f:
            ...
            print("Header: ")
            print(", ".join(header))
            print("Parsing gene records from {}".format(dbnsfp_gene_table_path))
        ...
        print("Done. dbNSFPGene table now contains {} records.".format(dbNSFPGene.objects.count()))
