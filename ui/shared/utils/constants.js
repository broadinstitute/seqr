...
const ORDERED_VEP_CONSEQUENCES = [
  ...
  },
  {
    ...
    text: 'Loss Of Functionn Duplication',
    value: 'DUP_LOF',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
  ...
  {
    description: 'Having genes partially overlapped by the SV\'s duplication',
    text: 'Partial Duplication',
    value: 'DUP_PARTIAL',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'A multiallelic SV predicted to have a LOF, DUP_LOF, COPY_GAIN, or DUP_PARTIAL',
    text: 'Multiallelic SV',
    value: 'MSV_EXON_OVR',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'An SV lies entirely within an intron',
    text: 'Intronic',
    value: 'INTRONIC',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'An SV\'s inversion spans genes entirely',
    text: 'Inversion Span',
    value: 'INV_SPAN',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'An SV to disrupt a UTR',
    text: 'UTR',
    value: 'UTR',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'An SV does not overlap coding sequence',
    text: 'Intergenic',
    value: 'INTERGENIC',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
  {
    description: 'An SV disruptes a promoter sequence (1 kb)',
    text: 'Promoter',
    value: 'PROMOTER',
    group: VEP_GROUP_SV_CONSEQUENCES,
  },
