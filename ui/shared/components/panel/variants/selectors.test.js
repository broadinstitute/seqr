...
test('getPairedSelectedSavedVariants', () => {
  ...
  const savedAllVariants = getPairedSelectedSavedVariants(STATE_WITH_2_FAMILIES,
    { project: { projectGuid: 'R0237_1000_genomes_demo' }, match: { params:  {} } })
  ...
  const savedReviewVariants = getPairedSelectedSavedVariants(
    ...
    { project: { projectGuid: 'R0237_1000_genomes_demo' }, match: { params:  { tag: 'Review' } } },
  )
  ...
  const savedNotesVariants = getPairedSelectedSavedVariants(
    STATE_WITH_2_FAMILIES,
    { project: { projectGuid: 'R0237_1000_genomes_demo' }, match: { params:  { tag: 'Has Notes' } } },
  )
  ...
  const savedFamilyVariants = getPairedSelectedSavedVariants(
    STATE_WITH_2_FAMILIES,
    { project: { projectGuid: 'R0237_1000_genomes_demo' }, match: { params:  { familyGuid: 'F011652_1' } } },
  )
  ...
  const savedAnalysisGroupVariants = getPairedSelectedSavedVariants(
    STATE_WITH_2_FAMILIES,
    {
      project: { projectGuid: 'R0237_1000_genomes_demo' },
      match: { params:  { analysisGroupGuid: 'AG0000183_test_group' } },
    },
  )
  ...
  const savedVariants = getPairedSelectedSavedVariants(
    ...
    {
      project: { projectGuid: 'R0237_1000_genomes_demo' },
      match: { params:  { variantGuid: 'SV0000004_116042722_r0390_1000' } },
    },
  )
