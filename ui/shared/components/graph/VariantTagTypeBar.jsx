...
import { EXCLUDED_TAG_NAME } from '../../utils/constants'


const VariantTagTypeBar = ({ project, familyGuid, sectionLinks = true, hideExcluded, ...props }) =>
  <HorizontalStackedBar
    ...
    data={(project.variantTagTypes || []).filter(
      vtt => !(hideExcluded && vtt.name === EXCLUDED_TAG_NAME),
    ).map((vtt) => {
