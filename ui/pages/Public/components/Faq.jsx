...
const FAQS = [
  {
    ...
    content: (
      <div>
        ...
        incomplete penetrance, etc.) within a family to efficiently identify a diagnostic or candidate cause of disease
      ...
      <div>
        ...
        <List ordered>
          ...
          <List.Item>
            ...
            that you can log in. seqr will display a demo project that you are welcome to play around with to test how
            it works
          </List.Item>
        </List>
        ...
        *If you would prefer to use your institutional or other non-Gmail email address, you can follow &nbsp;
        ...
        instructions on how to create an account that is associated with your non-Gmail, institutional email address,
    ...
    content: (
      <div>
        ...
        *AnVIL is a controlled-access NIH-designated data repository supported on the Terra platform. Users are expected
        ...
        procedures for handling genomic data. However, because seqr runs within Terra or AnVIL workspaces, no additional
    ...
    content: (
      <div>
        ...
        <a href="https://github.com/broadinstitute/seqr/blob/master/deploy/LOCAL_INSTALL.md" target="blank">documentation</a>
        ...
        <a href="https://github.com/broadinstitute/seqr/discussions" target="blank">Github discussions page</a>
        &nbsp; for general troubleshooting help. If after looking into our documentation, you still have questions that
        can
    ...
    content: (
      <div>
        ...
        reason a user is unable to log in to a seqr project is because the email being used to log in is different from
        the one granted access to the project workspace. <br /><br />

        If you are still having trouble after you have confirmed your email address is registered with AnVIL and is the
