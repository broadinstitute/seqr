...
export const STATE_WITH_2_FAMILIES = {
  ...
  individualsByGuid: {
    I021476_na19678_1: {
      ...
      mmeSubmissionGuid: 'MS021476_na19678_1',
      individualId: 'NA19678',
      displayName: 'NA19678',
      affected: 'N',
      caseReviewStatus: 'A',
  ...
  rnaSeqDataByIndividual: {
    I021476_na19678_1: {
      ...
      spliceOutliers: {ENSG00000228198: [{
        geneId: 'ENSG00000228198',
        isSignificant: true,
        pValue: 0.0004,
        pAdjust: 0.001,
  ...
  projectOverviewLoading: { isLoading: false },
