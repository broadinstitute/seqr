...
import {
  ...
  MITO_FREQUENCIES, SV_FREQUENCIES,
} from 'shared/components/panel/search/constants'
import {
  ALL_INHERITANCE_FILTER, DATASET_TYPE_VARIANT_CALLS, DATASET_TYPE_SV_CALLS, DATASET_TYPE_MITO_CALLS,
  NO_SV_IN_SILICO_GROUPS, VEP_GROUP_SV_NEW,
...
const DATASET_TYPE_PANEL_PROPS = {
  ...
  [DATASET_TYPE_VARIANT_MITO]: {
    [FREQUENCY_PANEL.name]: {
      fields: SNP_FREQUENCIES + MITO_FREQUENCIES,
    },
  },
  [DATASET_TYPE_VARIANT_SV]: {
    [FREQUENCY_PANEL.name]: {
      fields: SNP_FREQUENCIES + SV_FREQUENCIES,
    },
  },
}
