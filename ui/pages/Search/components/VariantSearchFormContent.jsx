...
import {
  ...
  MITO_FREQUENCIES, MITO_QUALITY_FILTER_FIELDS, SV_FREQUENCIES, SV_QUALITY_FILTER_FIELDS, CODING_IMPACT_DISPLAY_GROUPS,
...
const DATASET_TYPE_PANEL_PROPS = {
  [DATASET_TYPE_SNV_INDEL_CALLS]: {
    [ANNOTATION_PANEL.name]: {
      fieldLayout: annotationFieldLayout(
        [HIGH_IMPACT_GROUPS_SPLICE, MODERATE_IMPACT_DISPLAY_GROUPS, CODING_IMPACT_DISPLAY_GROUPS],
      ),
    },
