...
test('IndividualMetadata render and export', () => {
  ...
  expect(exportConfig.headers).toEqual([
    ...
    'chrom-1', 'pos-1', 'end-1', 'ref-1', 'alt-1', 'gene_of_interest-1', 'gene_id-1', 'seqr_chosen_consequence-1', 'transcript-1',
    ...
    'genetic_findings_id-2', 'variant_reference_assembly-2', 'chrom-2', 'pos-2', 'end-2',
  ...
  expect(exportConfig.processRow(DATA[0])).toEqual([
    ...
    'WES', '2017-02-05', '', undefined, 'Yes', 'NA20889_1_248367227', undefined, '1', 248367227, null, 'TC', 'T',
    'OR4G11P', 'ENSG00000240361', 'intron_variant', 'ENST00000505820', 'c.3955G>A', 'c.1586-17C>G', 'Heterozygous', undefined, undefined,
    'unknown', 'Candidate', 'Partial', 'HP:0000501|HP:0000365', undefined, 'CA1501729', 'NA20889_1_249045487', undefined,
    '12', '49045487', '49045898', undefined, undefined, undefined, undefined, undefined,
