...
test('IndividualMetadata render and export', () => {
  ...
  expect(exportConfig.headers).toEqual([
    ...
    'disease_id', 'disease_description', 'disorders', 'affected_status', 'hpo_present', 'hpo_absent',
    'phenotype_description', 'analysis_groups', 'analysis_status', 'solve_state', 'MME', 'data_type', 'date_data_generation',
