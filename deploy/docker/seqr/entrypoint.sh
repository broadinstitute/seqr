...
0 0 * * 0 /usr/local/bin/python /seqr/manage.py import_all_panels https://panelapp.agha.umccr.org/api/v1 >> /proc/1/fd/1 2>&1
0 0 * * 0 /usr/local/bin/python /seqr/manage.py import_all_panels https://panelapp.genomicsengland.co.uk/api/v1 >> /proc/1/fd/1 2>&1
