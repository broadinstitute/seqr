# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-06 16:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequencing_type', models.CharField(choices=[(b'WES', b'Exome'), (b'WES', b'Whole Genome'), (b'RNA', b'Whole Genome')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maternal_id', models.CharField(blank=True, max_length=100, null=True)),
                ('paternal_id', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('case_review_status', models.CharField(blank=True, choices=[(b'U', b'Uncertain'), (b'A', b'Accepted: Platform Uncertain'), (b'E', b'Accepted: Exome'), (b'G', b'Accepted: Genome'), (b'R', b'Not Accepted'), (b'H', b'Hold'), (b'Q', b'More Info Needed')], max_length=1, null=True)),
                ('case_review_status_last_modified_date', models.DateTimeField(auto_now=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature_id', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('chrom', models.CharField(blank=True, max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
                ('project_category', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('deprecated_project_id', models.CharField(blank=True, default=b'', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual_id', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('color', models.CharField(default=b"'#1f78b4", max_length=10)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seqr.Project')),
            ],
        ),
