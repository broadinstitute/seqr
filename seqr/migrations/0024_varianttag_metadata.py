...
def merge_project_sanger_tags(apps, schema_editor):
    ...
    if project_sanger_tag_types:
        ...
        main_tag_type.last_modified_date=timezone.now()
        log_model_update(logger, main_tag_type, user=None, update_type='update', update_fields=['project', 'last_modified_date'])
        main_tag_type.save()
