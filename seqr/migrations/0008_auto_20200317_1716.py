...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sample',
            name='dataset_type',
            field=models.CharField(choices=[(b'VARIANTS', b'Variant Calls'), (b'SV', b'SV Calls')], max_length=10),
        ),
        migrations.AlterField(
            model_name='sample',
        ...
        migrations.AlterField(
            model_name='sample',
            name='sample_type',
            field=models.CharField(choices=[(b'WES', b'Exome'), (b'WGS', b'Whole Genome')], max_length=10),
        ),
    ]
