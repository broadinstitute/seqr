...
SCREEN_MAP = {c: i for i, c in enumerate([
    'CTCF-bound', 'CTCF-only', 'DNase-H3K4me3', 'PLS', 'dELS', 'pELS', 'DNase-only', 'low-DNase',
])}
...
SV_TYPE_MAP = {c: i for i, c in enumerate([
    'gCNV_DEL', 'gCNV_DUP', 'BND', 'CPX', 'CTX', 'DEL', 'DUP', 'INS', 'INV', 'CNV',
])}
