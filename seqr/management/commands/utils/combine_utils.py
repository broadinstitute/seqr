...
def choose_one(model, field_name, value_a, value_b, default_value=None, use_lower_value=False, use_higher_value=False):
    ...
    Args:
        ...
        use_lower_value (bool): if True, and both values are set 
    Returns:
