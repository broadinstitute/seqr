...
class RunProtgresDatabaseBackupTest(TestCase):
    ...
    def test_command_no_argument(self, mock_datetime, mock_os):
        ...
        self.assertEqual(
            ...
            'gsutil -m cp /postgres_backups/seqrdb_unknown_backup_2020-04-27__20-16-01.txt.gz gs://db_back_bucket/postgres/seqrdb_unknown_backup_2020-04-27__20-16-01.txt.gz\n' +
    ...
    def test_command_with_arguments(self, mock_datetime, mock_os):
        ...
        self.assertEqual(
            ...
            'gsutil -m cp /postgres_backups/seqrdb_test_deployment_backup_2020-04-27__20-16-01.txt.gz gs://test_bucket/postgres/seqrdb_test_deployment_backup_2020-04-27__20-16-01.txt.gz\n' +
