...
# 2024-01-29 mfranklin: Maybe come back to this, it looks like the delete isn't working
# as expected? We don't really use this functionality, it's also so hard to debug!
#
...
#
#     def test_command_with_other_project(self, mock_logger, mock_safe_post_to_slack, mock_does_file_exist):
#         mock_does_file_exist.return_value = False
