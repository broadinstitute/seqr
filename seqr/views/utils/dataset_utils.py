...
def match_sample_ids_to_sample_records(
    ...
    logger.info(str(len(sample_id_to_sample_record)) + " exact sample record matches", user)
    ...
    if len(remaining_sample_ids) > 0:
        ...
        logger.info(str(len(sample_id_to_individual_record)) + " matched individual ids", user)
