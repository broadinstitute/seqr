...
def update_family_assigned_analyst(request, family_guid):
    ...
    check_project_permissions(family.project, request.user, session=request.session, can_edit=False)
...
def update_family_pedigree_image(request, family_guid):
    ...
    # check permission
    check_project_permissions(family.project, request.user, session=request.session, can_edit=True)
