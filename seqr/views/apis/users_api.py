...
from seqr.views.utils.permissions_utils import get_project_guids_user_can_view, get_project_families_and_check_view_permission, \
...
def get_project_collaborator_options(request, project_guid):
    ...
    users = None if families else get_project_collaborators_by_username(
