...
from seqr.models import UserPolicy, Project, Family, CAN_VIEW, CAN_EDIT
...
from seqr.views.utils.permissions_utils import get_project_guids_user_can_view, check_family_view_permission, \
