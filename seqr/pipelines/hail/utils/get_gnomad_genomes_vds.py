...
def get_gnomad_genomes_vds(hail_context, genome_version):
    if genome_version == "37":
        gnomad_genomes_vds_path = 'gs://gnomad-public/release-170228/gnomad.genomes.r2.0.1.sites.vds'
    elif genome_version == "38":
        gnomad_genomes_vds_path = 'gs://seqr-reference-data/GRCh38/gnomad/gnomad.genomes.r2.0.1.sites.liftover.b38.vds'
    else:
    ...
    gnomad_genomes_vds = (
        hail_context.read(gnomad_genomes_vds_path)
            .split_multi()
            .annotate_variants_expr(expr)
            .annotate_variants_expr("va = select(va, for_seqr)")
    )

    #pprint.pprint(gnomad_genomes_vds.variant_schema)

    return gnomad_genomes_vds