...
# Importing these registers their model classes with Django's app registry (apps.get_model()),
# which fixture loaddata needs to resolve "clickhouse_search.<model>" identifiers. Nothing else
# in this package imports them directly otherwise. Must come after the DEFAULT_NAMES patch above -
# these modules' Meta classes use the custom fields it allowlists.
