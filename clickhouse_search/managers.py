...
class BaseEntriesManager(SearchQuerySet):
    ...
    def _search_call_data(self, entries, sample_data, inheritance_mode=None, inheritance_filter=None, qualityFilter=None, pathogenicity=None, exclude_keys=None, annotate_carriers=False, annotate_hom_alts=False, **kwargs):
