...
def conditionally_recreate_repartitioned_snv_indel_entries(apps, schema_editor):
    with connections['clickhouse_write'].cursor() as cursor:
        ...
        if cursor.fetchone()[0] > 0:
            return
        new_partition_by = f"(project_guid, farmHash64(family_guid) % coalesce(joinGet('{DATABASES['clickhouse_search']['NAME']}.project_partitions', 'n_partitions', project_guid), 1))"
