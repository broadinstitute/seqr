    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_exon', clickhouse_backend.models.UInt8Field(db_column='numExon')),
            ...
            options={
                ...
                'engine': clickhouse_search.backend.engines.EmbeddedRocksDB(0, '/var/seqr/clickhouse-data/GRCh38/GCNV/annotations', flatten_nested=0, primary_key='key'),
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'engine': clickhouse_search.backend.engines.EmbeddedRocksDB(0, '/in-memory-dir/GRCh38/GCNV/annotations', flatten_nested=0, primary_key='key'),
            },
            managers=[
                ('objects', django.db.models.manager.Manager()),
                ('_overwrite_base_manager', django.db.models.manager.Manager()),
