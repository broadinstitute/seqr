    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'engine': clickhouse_search.backend.engines.EmbeddedRocksDB(0, f'{CLICKHOUSE_DATA_DIR}/tmp/GRCh38/GCNV/annotations', flatten_nested=0, primary_key='key'),
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'engine': clickhouse_search.backend.engines.EmbeddedRocksDB(0, f'{CLICKHOUSE_IN_MEMORY_DIR}/tmp/GRCh38/GCNV/annotations', flatten_nested=0, primary_key='key'),
            },
            managers=[
                ('objects', django.db.models.manager.Manager()),
                ('_overwrite_base_manager', django.db.models.manager.Manager()),
