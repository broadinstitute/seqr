# Generated by Django 4.2.21 on 2025-06-11 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transcripts', clickhouse_search.backend.fields.NestedField(base_fields=[
                    ('aminoAcids', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('biotype', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('canonical', clickhouse_backend.models.UInt8Field(blank=True, null=True)), 
                    ('codons', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('consequenceTerms', clickhouse_backend.models.ArrayField(base_field=clickhouse_backend.models.StringField())), 
                    ('geneId', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('hgvsc', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('hgvsp', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('isLofNagnag', clickhouse_backend.models.BoolField(blank=True, null=True)), 
                    ('lofFilters', clickhouse_backend.models.ArrayField(base_field=clickhouse_backend.models.StringField(blank=True, null=True))), 
                    ('majorConsequence', clickhouse_backend.models.StringField(blank=True, null=True)), 
                    ('transcriptId', clickhouse_backend.models.StringField()), 
                    ('transcriptRank', clickhouse_backend.models.UInt8Field())]
                )),
            ],
            options={
