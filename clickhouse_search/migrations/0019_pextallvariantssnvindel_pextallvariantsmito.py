...
CREATE DICTIONARY `GRCh38/$dataset_type/reference_data/pext/search`
(
    chrom String,
    start UInt32,
    end UInt32,
...
SOURCE(CLICKHOUSE(
    ...
    QUERY 'SELECT chrom, pos as start, pos as end, exp_prop_mean FROM `GRCh38/$dataset_type/reference_data/pext/all`'
))
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clickhouse_search', '0018_clinvarseqrvariantsgrch37snvindel_and_more'),
    ]
