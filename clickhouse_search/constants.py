from seqr.utils.constants import AFFECTED_STATUS_AFFECTED, AFFECTED_STATUS_UNAFFECTED

AFFECTED = AFFECTED_STATUS_AFFECTED
UNAFFECTED = AFFECTED_STATUS_UNAFFECTED
