    ...
    def test_mito_update_vat(
        ...
        self.assertCountEqual(
            ...
            hl.Struct(
                ...
                mitotip=hl.Struct(trna_prediction=None),
                rg37_locus=hl.Locus(
                    contig='MT',
                    position=3,
                    reference_genome='GRCh37',
        ...
        self.assertCountEqual(
            ...
            [
                ...
                hl.Struct(
                    ...
                    sorted_gene_consequences=[
                        hl.Struct(gene_id='ENSG00000135835', major_consequence='LOF'),
                        hl.Struct(gene_id='ENSG00000153029', major_consequence='LOF'),
                        hl.Struct(gene_id='ENSG00000135823', major_consequence='LOF'),
                        hl.Struct(gene_id='ENSG00000143324', major_consequence='LOF'),
                    ],
                    start_locus=hl.Locus(
                        contig='chr1',
                        position=180540234,
